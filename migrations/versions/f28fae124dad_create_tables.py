...
Revision ID: f28fae124dad
Revises: 
Create Date: 2022-09-26 19:35:43.324159
...
def upgrade():
    ...
    op.create_index(op.f('ix_benchmark_symbol'), 'benchmark', ['symbol'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_benchmark_symbol'), table_name='benchmark')
